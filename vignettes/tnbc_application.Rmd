...
![plot of chunk visualizing some samples](./figures/visualizing_some_samples_1.png)
...
![plot of chunk filtering to just immune cells and visualizing](./figures/filtering_to_just_immune_cells_and_visualizing_1.png)
...
pd1 + pd2 + 
  ...
  plot_layout(ncol = 2, nrow = 2)
```
![plot of immune cell persistence diagrams](./figures/immune_cell_filtration_1.png)
